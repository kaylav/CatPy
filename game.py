...
def loadImage(data, filename):
    ...
    filenames = ["images/tree.gif","images/food.gif","images/brush.gif","images/bed.gif", "images/fish.gif", "images/bowl.gif", "images/petcat.gif","images/fence.gif", "images/sheep.gif"] #images labeled for reuse from google.com 
...
def welcomeTimerFired(data):
    if data.filename == "images/cat1.gif":
         data.filename = "images/cat2.gif"
    else:
        data.filename = "images/cat1.gif"
...
def backyardRedrawAll(canvas, data):
    ...
    data.filename = "images/cathead.gif"
...
def feedGameTimerFired(data):
    ...
    #def imageCollide(image1, image2, x1, y1, x2, y2) 
        if imageCollide(data.imageBowl, getImage(data, "images/fish.gif"), data.bowlX, data.bowlY, data.fishes[i][0], data.fishes[i][1]):
...
def drawFish(canvas, data, x , y): #from lab6 HW 
    imageFish = getImage(data, "images/fish.gif")
...
def napGameTimerFired(data):
    ...
    for i in range(len(data.fences)-1):
        data.fences[i][0] -= 10
